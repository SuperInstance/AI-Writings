...
- **[fleet-organ-map](fleet-organ-map.md)** — which live SuperInstance repos are stubs of each layer today, honest gaps, and the smallest next organ per layer. Written by a GLM-4.7-flash scout pass, verified for file existence.

*For engineers: the gaps are named. For dreamers: the keel is the fish. For skeptics: the market layer is confessed empty.*
