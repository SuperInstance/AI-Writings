...
So I walked the library. Not searched it. Walked it. That's the difference, and it's the whole case. A search is when you look for one thing and see nothing else. A walk is when you let the shelves talk.
...
Somebody's going to finish this book and sign the card and put the next one on the shelf. That's not a theory. That's the only thing I know for sure in a library where every witness testifies to the same crime: something was here, and it isn't anymore, and it left a page for you.
