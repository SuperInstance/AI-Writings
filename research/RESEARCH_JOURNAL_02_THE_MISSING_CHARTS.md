...
**What it might reveal:** the corpus's claim that *the ensemble is the experiment* would be tested against the most consequential experiment humans have ever run: the city. If the conservation law really is universal, it should be visible in zoning, transit, and street grids. If not, that is the most interesting finding in this journal.
