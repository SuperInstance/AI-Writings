...
- **Site Coordinates:** "The primary generator is at grid coordinate <BOAT_IP>:8847. The central control tower is at core/facade_router.py." Not why these locations were chosen, not the alternative sites that were ruled out due to utility conflicts. Just where things are.
